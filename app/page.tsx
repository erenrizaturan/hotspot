...
export default function PanelPage() {
  ...
  if (!loaded) {
    return (
      <div className="min-h-[100dvh] flex items-center justify-center" style={{ background: "#0a0b0f" }}>
        <div className="text-center space-y-3">
          <div className="w-8 h-8 rounded-full border-2 border-[#10b981] border-t-transparent animate-spin mx-auto" />
          <p className="text-sm" style={{ color: "#8b92a5" }}>Kazan ısınıyor…</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-[100dvh] pb-24" style={{ background: "#0a0b0f" }}>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="text-white font-bold text-lg" style={{ letterSpacing: "-0.5px" }}>HotSpot</span>
        </div>
        <span
      ...
      <main className="px-4 space-y-3 pt-6">
        ...
        <div className="pt-2 pb-2 space-y-1.5">
          <p className="text-xs flex items-center gap-1.5" style={{ color: "#8b92a5" }}>
